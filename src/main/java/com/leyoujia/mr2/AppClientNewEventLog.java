...
public class AppClientNewEventLog {
    private static Logger logger = LogManager.getLogger(AppClientNewEventLog.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "AppClientNewEventLog");
        job.setJarByClass(AppClientNewEventLog.class);
