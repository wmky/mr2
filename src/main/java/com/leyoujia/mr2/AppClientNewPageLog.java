...
public class AppClientNewPageLog {
    private static Logger logger = LogManager.getLogger(AppClientNewPageLog.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "AppClientNewPageLog");
        job.setJarByClass(AppClientNewPageLog.class);
